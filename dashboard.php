...
// =========================================================================
// 🔒 1. LOGIN/SESSION CHECK (โค้ดที่ถูกเพิ่มเข้ามาเพื่อให้ต้อง Login ก่อน)
// =========================================================================
session_start();
// **⚠️ แก้ไข 1:** เปลี่ยน 'user_id' ให้เป็นชื่อตัวแปร Session ที่ระบบ Login ของคุณใช้
if (!isset($_SESSION['user_id']) || empty($_SESSION['user_id'])) {
    // **⚠️ แก้ไข 2:** เปลี่ยน 'login.php' เป็นชื่อไฟล์ Login ของคุณ
...
<body class="p-3 p-md-4">
  <div class="container-fluid">
    ...
    <div class="text-center mt-4">
        <a href="logout.php" class="btn btn-outline-light">ออกจากระบบ (Logout)</a>
    </div>
  </div>
